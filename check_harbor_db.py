...
'''
check_harbor_db.py script will return a true/false value representing 
if there have been any changes made to database.sql. 
'''
...
try:
    ...
    if harborDbHash != pipelineDbHash:
        ...
        #  If no changes have been made, we can continue using a previous build.
        print('false')
